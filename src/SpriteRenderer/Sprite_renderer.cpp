...
SpriteRenderer::SpriteRenderer(const Shader &pshader)
{
    this->shader = pshader;
    this->initRenderData();
}
...
void SpriteRenderer::DrawSprite(const Texture &texture, glm::vec2 position, glm::vec2 size, float rotate)
{
    // prepare transformations
    this->shader.Use();
    glm::mat4 model = glm::mat4(1.0f);
...
void SpriteRenderer::DrawSprite(const Texture &texture, glm::vec2 position, glm::vec2 size)
{
    // prepare transformations
    this->shader.Use();
    glm::mat4 model = glm::mat4(1.0f);
